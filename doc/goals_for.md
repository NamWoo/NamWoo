...
- **The Horizontal Bar (ㅡ):** Reflecting on how external projects and company goals shaped my journey.
- **The Vertical Bar (I):** Understanding where my individual strengths and interests lie within the 'T' model.

>`T`자형 인재로 나를 표현한다고 할 때, 나의 `T`의 `I`는 어느 부분이고 `ㅡ`는 어느 부분인지, 그리고 `T`자형에서 `I`자를 어떻게 두껍게 가져갈지 생각해보고 정의해보기.

### Looking Back on 2021
- Realized the importance of aligning personal goals with company objectives.
- Felt like I was drifting, adjusting my course based on external influences rather than setting my own direction.
...
- **Focus:** Combining various skills to step beyond a simple generalist role.
...
- Questioning if a 'Quantum Jump' in skills and experience was achieved.
- Still in a beta phase, with a need for more energy to leap forward significantly.
- Gained clarity on dislikes and uncomfortable situations, a step towards self-understanding.
...
## 🌟 Goals for 2023: *Say No!*
### Embracing Selectivity and Focus
- **Mindset:** Learning to assertively say no, express dislikes, and focus intensely on what truly matters.
- **Inspiration:** Adopting Warren Buffett's 25/5 rule - ruthlessly eliminating the non-essential to concentrate on the vital few.

>아닌 것을 아니라고 말하기, 싫은걸 싫다고 말하기, 워렌버핏의 25/5 규칙처럼 버릴건 과감하게 버리고 쳐낼건 모조리 쳐내어서 나머지에만 몰두할 수 있도록 하는 마음가짐 기르기

### Core Focus
- Dedication to cutting out everything superfluous, concentrating solely on what I love, the people I care about, and that one thing I truly desire.
...
- **Embracing Assertiveness:** I said no, expressed dislikes, and identified what wasn't right. Transitioned out of my company and moved on to new opportunities.
- **Learning to Speak Up:** Realized I could have been more assertive in situations that warranted it. Discovered that politeness isn't always necessary.
